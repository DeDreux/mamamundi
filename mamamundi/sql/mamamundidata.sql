...
values (1,'europe'),(2,'afrique'),(3,'Amerique du Nord'),(4,'Amerique du Sud'),(5,'Asie'),(6,'Oceanie');

/*Données table Pays*/
insert into pays (pays_id,pays_libelle,pays_region_id)
values (1,'France',1),(2,'Wakanda',2),(3,'R�publique Democratique du Congo',2),(4,'Australie',6),(5,'Etats-Unis d Am�rique',3),(6,'Japon',5),(7,'Mexique',4);
...
values 	(1,"Palmarin",'2017-02-18',1,1),
	(2,"Watergate",'2017-02-18',2,2),
	(3,"Apollo",'2017-02-18',3,3),
	(4,"Horizon Zero",'2017-02-18',4,4),
	(5,"Abyss",'2017-02-18',5,5),
	(6,"Lune",'2017-02-18',6,6),
	(7,"T�te dans les �toiles",'2017-02-18',7,7);
...
insert into activite(activite_id,activite_libelle,activite_article_id,activite_projet)
...
insert into enfant(enfant_id,enfant_nom,enfant_prenom,enfant_photo,enfant_parent,enfant_parrain)
values 	(1,"Grayson","Dick","C:\Utilisateurs\Asus\Documents\nightwing.png",4,NULL),
	(2,"Danvers","Linda","C:\Utilisateurs\Asus\Documents\supergirl.png",8,NULL),
	(3,"Rayner","Kyle","C:\Utilisateurs\Asus\Documents\Ion.png",10,5),
	(4,"Troy","Donna","C:\Utilisateurs\Asus\Documents\wondergirl.png",NULL,7);

/*Données table Suivi*/
insert into suivi(suivi_id,Compte_rendu,suivi_projet)
...
values 	(1,"mise au point de mi-travaux",'2016-12-18',2),
	...
	(5,"Point Financement Horison Zero",'2018-01-15',7);
